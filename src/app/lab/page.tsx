  ...
  return (
    <div className="space-y-4">
      <h1 className="text-2xl font-semibold">
        App Router file conventions lab
      </h1>
      <p className="text-sm text-slate-700">
        This subroute includes <code>loading.tsx</code>,{" "}
        <code>not-found.tsx</code>, <code>error.tsx</code>,{" "}
        <code>route.ts</code>, <code>template.tsx</code>, and a parallel-route{" "}
      ...
      <ul className="space-y-2 text-sm">
        <li>
          ...
          and <code>/lab/billing</code> are inside a <code>(workspace)</code>{" "}
          route group and share group layout/template without adding{" "}
          <code>workspace</code> to the URL.
        </li>
        <li>
          <Link
        ...
        <li>
          ...
          lets you test intercepted route behavior for{" "}
          <code>/lab/photo/[id]</code>.
        </li>
        <li>
        ...
        <li>
          ...
          triggers <code>notFound()</code> and renders{" "}
