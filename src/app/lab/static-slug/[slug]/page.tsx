  ...
  return (
    <article className="space-y-3">
      ...
      <p className="text-sm text-slate-700">
        This is <code>/lab/static-slug/[slug]</code> with <code>generateStaticParams()</code>.
      </p>
      <p className="text-sm text-slate-700">
      ...
      <p className="text-sm text-slate-700">
        Mental model: dynamic segment pattern, but known params can be prerendered.
      </p>
      <div className="flex gap-2 text-sm">
        <Link className="rounded-md bg-slate-900 px-3 py-2 text-white" href="/lab/static-slug/alpha">
          alpha
        </Link>
        <Link className="rounded-md bg-slate-900 px-3 py-2 text-white" href="/lab/static-slug/beta">
          beta
        </Link>
        <Link className="rounded-md bg-slate-700 px-3 py-2 text-white" href="/lab/static-slug/gamma">
          gamma
        </Link>
      </div>
    </article>
